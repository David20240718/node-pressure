...
//MinerReward: MinerBasicReward,VotesWeightReward,ReElectionReward
    ...
    public class ProfitContract : BaseContract<ProfitMethod>
    {
        ...
        public GetAllProfitsMapOutput GetAllProfitsMap(string account, Hash? schemeId)
        {
            var profitsMap = CallViewMethod<GetAllProfitsMapOutput>(ProfitMethod.GetAllProfitsMap, new GetAllProfitsMapInput
            {
                SchemeId = schemeId,
                Beneficiary = account.ConvertAddress()
            });
        ...
        public GetAllProfitAmountOutput GetAllProfitAmount(string account, Hash? schemeId)
        {
            // var newTester = GetNewTester(account);
            return CallViewMethod<GetAllProfitAmountOutput>(ProfitMethod.GetAllProfitAmount, new GetAllProfitAmountInput
            {
                SchemeId = schemeId,
                Beneficiary = account.ConvertAddress(),
                Symbol = "ELF"
