...
public class ConfigInfo
{
    ...
    [JsonProperty("CryptoBoxInfo")] public CryptoBoxInfo CryptoBoxInfo { get; set; }
...
public class CryptoBoxInfo
{
    [JsonProperty("BoxCount")] public int BoxCount { get; set; }
    [JsonProperty("TransferCryptoCount")] public int TransferCryptoCount { get; set; }
